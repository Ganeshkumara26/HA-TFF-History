# Vivado Synthesis Script for HA-TFF Full System v002 (v010)
...
read_verilog ../../05_RTL/rtl_v010/ha_tff_system_top_v002.v

synth_design -top ha_tff_system_top_v002 -part xc7a100tcsg324-1

# Constraints for 156.25 MHz clock (6.4ns)
create_clock -period 6.400 -name clk [get_ports clk]

report_utilization -file utilization_report.txt
report_timing_summary -file ../../09_Timing/timing010/timing_summary.txt

write_checkpoint -force ha_tff_system_top_v002_synth.dcp
