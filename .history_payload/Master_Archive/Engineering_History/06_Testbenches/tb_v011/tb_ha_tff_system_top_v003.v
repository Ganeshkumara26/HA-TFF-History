...
module tb_ha_tff_system_top_v003;
    ...
    initial begin
        $dumpfile("tb_ha_tff_system_top_v003.vcd");
        $dumpvars(0, tb_ha_tff_system_top_v003);
        clk = 0;
        forever #3.2 clk = ~clk;
    end
    ...
    initial begin
        ...
        // Inject a payload on AXI Stream that Datapath allows (we force the datapath decision)
