...
module tb_snn_layer_v002;
    ...
    initial begin
        $dumpfile("tb_snn_layer_v002.vcd");
        $dumpvars(0, tb_snn_layer_v002);
        clk = 0;
    ...
    initial begin
        ...
        $display("[%0t] Experiment 3: Low-rate Anomaly (Should leak and not fire, testing BUG-003 fix)", $time);
        inject_spikes(8'b00111100, 1);
        #64; // Wait 10 cycles to leak
        inject_spikes(8'b00111100, 1);
        #64;
        inject_spikes(8'b00111100, 1);
        #64;
