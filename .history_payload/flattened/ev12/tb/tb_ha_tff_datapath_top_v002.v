...
module tb_ha_tff_datapath_top_v002;
    ...
    initial begin
        $dumpfile("tb_ha_tff_datapath_v005.vcd");
        $dumpvars(0, tb_ha_tff_datapath_top_v002);
        clk = 0;
    ...
    always @(posedge clk) begin
        if (match_valid) begin
            $display("[%0t] PIPELINED DATAPATH MATCH RESULT:", $time);
    ...
    initial begin
        ...
        send_word(64'h0000C0A801010A00, 8'hFF, 0); // Word 3
        send_word(64'h000104D200500008, 8'hFF, 0); // Word 4
        send_word(64'hDEADBEEF00000000, 8'hF0, 1); // Word 5
        @(posedge clk);
        s_axis_tvalid <= 0;
        s_axis_tlast <= 0;
        ...
        send_word(64'h000104D200510008, 8'hFF, 0);
        ...
        send_word(64'hEEEEEEEE08004500, 8'hFF, 0);
        send_word(64'h0028ABCD40004011, 8'hFF, 0);
        send_word(64'h0000888888880A00, 8'hFF, 0);
